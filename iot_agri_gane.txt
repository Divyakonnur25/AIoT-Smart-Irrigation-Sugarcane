...
Serial.println("AT+CMGS=\"+60184664772\"");delay(400);
...
Serial.println("AT+CMGF=1");delay(400);Serial.println("AT+CMGS=\"+60184664772\"");delay(400);   // use your 10 digit cell no. here
...
while(test47_flag){Serial.print("AT+HTTPPARA=\"URL\",\"http://iotwaterquality.com/iot_farming/put_motor.php?mot=motor");
...
while(test7_flag){Serial.print("AT+HTTPPARA=\"URL\",\"http://iotwaterquality.com/iot_farming/put_data.php");
////////////////////////////////////////////////////////////////////////////////
...
boolean test17_flag=1;while(test17_flag){Serial.print("AT+HTTPPARA=\"URL\",\"http://iotwaterquality.com/iot_farming/get_data.php");Serial.print("\"");Serial.print("\r\n");
