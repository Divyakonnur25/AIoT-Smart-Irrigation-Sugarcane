...
lcd.setCursor(0,1);lcd.print("Smart Farming");
...
lcd.clear();  
/////////////////////////////////////////////////////////////////////////////////////////
TEMP = analogRead(0);TEMP=TEMP/2;TEMP=TEMP/10;
lcd.setCursor(0,0);lcd.print("T:");lcd.setCursor(3,0);lcd.print(TEMP);delay(2000);
lcd.setCursor(0,0);lcd.print("T:");lcd.setCursor(3,0);lcd.print(TEMP);delay(200);if(TEMP<45){dt=0;delay(100);}
if(TEMP>45)
{
dt=dt+1;
if(dt==2)
...
Serial.println("AT+CMGS=\"7760120487\"");delay(500);
Serial.println("Over Temperature\n");delay(500);
Serial.print("Temp=");delay(100);Serial.print(TEMP);delay(1000);Serial.print("  ");Serial.write(26);delay(1000);
...
HUM=HUM+18;
lcd.setCursor(0,1);lcd.print("H:");lcd.setCursor(3,1);lcd.print(HUM);delay(2500);if(HUM<50){dh=0;delay(100);}
if(HUM>50)
{
dh=dh+1;
if(dh==2)
...
Serial.print("HUM= ");delay(100);Serial.print(HUM);delay(1000);Serial.print("  ");Serial.write(26);delay(1000);
Serial.print("AT\r\n");delay(1000);Serial.print("AT\r\n");delay(1000);Serial.println("AT+CMGF=1");delay(1000);
}
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
lcd.setCursor(0,1);lcd.print("MOTOR ON");delay(2000);digitalWrite(motor, LOW);
Serial.print("AT\r\n");delay(1000);Serial.print("AT\r\n");delay(1000);
Serial.println("AT+CMGF=1");delay(500);Serial.println("AT+CMGS=\"7760120487\"");delay(500);   // use your 10 digit cell no. here
...
delay(200);digitalWrite(buzzer, HIGH);delay(200);digitalWrite(buzzer, LOW);
delay(200);digitalWrite(buzzer, HIGH);delay(200);digitalWrite(buzzer, LOW);
lcd.clear();send_gprs();delay(500);
delay(200);digitalWrite(buzzer, HIGH);delay(200);digitalWrite(buzzer, LOW);
delay(200);digitalWrite(buzzer, HIGH);delay(200);digitalWrite(buzzer, LOW);
lcd.clear();lcd.setCursor(0,0);lcd.print("SENDING SMS");delay(2000);
lcd.clear();
lcd.setCursor(0,0);lcd.print("FEILD AT WET");
lcd.setCursor(0,1);lcd.print("MOTOR OFF");delay(2000);digitalWrite(motor, HIGH);
Serial.print("AT\r\n");delay(1000);Serial.print("AT\r\n");delay(1000);
Serial.println("AT+CMGF=1");delay(500);Serial.println("AT+CMGS=\"7760120487\"");delay(500);  
...
while(test47_flag)
{Serial.print("AT+HTTPPARA=\"URL\",\"http://iotwaterquality.com/iot_agri_somash/put_motor.php?mot=motor");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
boolean at_flagd=1;while(at_flagd){Serial.println("AT");
while(Serial.available()>0){if(Serial.find("OK"))at_flagd=0;}delay(1000);}
}
...
while(test7_flag)
{Serial.print("AT+HTTPPARA=\"URL\",\"http://iotwaterquality.com/iot_agri_somash/put_data.php");
////////////////////////////////////////////////////////////////////////////////
...
void pump_gprs()
{
boolean at_flagd=1;while(at_flagd)
{Serial.println("AT");while(Serial.available()>0)
{if(Serial.find("OK"))at_flagd=0;}delay(1000);}
lcd.clear();lcd.print("PING TO WEBSITE");
boolean test17_flag=1;while(test17_flag)
{Serial.print("AT+HTTPPARA=\"URL\",\"http://iotwaterquality.com/iot_agri_somash/get_data.php");
Serial.print("\"");Serial.print("\r\n");
...
{
if(!(strncmp(str,"ON",2)))
{lcd.setCursor(1,1);lcd.print("MOTOR  ON");delay(500);digitalWrite(motor,LOW);delay(500);}
else if(!(strncmp(str,"OFF",3)))
{lcd.setCursor(1,1);lcd.print("MOTOR OFF");delay(500);digitalWrite(motor,HIGH);delay(500);}
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void gsm_init()
{
lcd.clear();lcd.print("GSM TESTING..");
boolean at_flag=1;while(at_flag)
...
while(echo_flag)
{Serial.println("ATE0"); 
while(Serial.available()>0){if(Serial.find("OK"))echo_flag=0;}delay(1000);}
